...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{PICs/buchruecken}
    \caption{Usage of the command \texttt{\textbackslash{}citepic}: \citepic{ANG10}}\label{Abb5}
\end{figure}
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{PICs/buchruecken}
    \caption{usage of the command \texttt{\textbackslash{}citefig}: \citefig{ANG10}{30}}\label{Abb6}
\end{figure}
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{PICs/buchruecken}
    \caption{usage of the command \texttt{\textbackslash{}citefigm}: \citefigm{ANG10}{30}}\label{Abb7}
\end{figure}
