...
%
\title{Short-Term Water Level Forecasting for the Danube Using Machine Learning}
\author{David Zelenay, BSc.}
\studentnumber{2410854045}
...
\place{Vienna}
\kurzfassung{\input{chapters/0_kurzfassung.tex}}
\schlagworte{Flusspegelvorhersage, Kurzzeitprognose, Zeitreihenprognose, Maschinelles Lernen, Modellvergleich, Donau}
\outline{\input{chapters/0_abstract.tex}}
\keywords{river water level forecasting, short-term forecasting, time series forecasting, machine learning, model comparison, Danube River}
...
% TODO check where Table 10 is. -> AI Usage table
...
The source code used in this thesis is available at: \url{https://github.com/cellularegg/uas-master-thesis-code}.
\begin{figure}[htbp]
  \centering
...
\begin{table}[htbp]
  \centering
  \input{tables/feature_subset_definitions.tex}
  \caption{Definition of the six input feature subsets.}\label{tab:feature-subset-definitions}
\end{table}
\begin{table}[htbp]
  \centering
  \input{tables/hyperparameter_search_space_ridge.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/hyperparameter_search_space_mlp.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/hyperparameter_search_space_xgboost.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/hyperparameter_search_space_extra_trees.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/hyperparameter_search_space_rnn.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/feature_subset_performance_comparison_ridge.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/feature_subset_performance_comparison_mlp.tex}
...
\begin{table}[htbp]
  \centering
  \input{tables/feature_subset_performance_comparison_extra_trees.tex}
