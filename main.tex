...
\aitoolentry{Chat GPT (5.6 Sol, Tera and Luna)}{Coding Assistance}{Code review, code completion, and code generation}
\aitoolentry{Claude (Sonet 5, Opus 5)}{Coding Assistance}{Code review, code completion, and code generation}
\aitoolentry{Chat GPT (5.6 Sol, Tera and Luna)}{Grammar and Spelling}{Grammar, spelling and translation check of the entire document}
\aitoolentry{Claude (Sonet 5, Opus 5)}{Grammar and Spelling}{Grammar, spelling and translation check of the entire document}
